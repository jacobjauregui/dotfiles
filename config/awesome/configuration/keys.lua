...
awful.keyboard.append_global_keybindings({
	...
	-- _______________________ [ Apps ] _______________________________________
	...
	-- ______________________ [ Focus Clients ] _______________________________
	...
	-- _______________________ [ Resize clients ] _____________________________
	
	-- Rezize Clien to Up
	awful.key({ mod, ctrl }, "i", function(c)
	...
	-- ________________________ [ Bling ] _____________________________________
	...
	--- Delete client from tabbed layout
	...
	-- _______________________ [ ACPI Keys ] __________________________________
...
client.connect_signal("request::default_keybindings", function()
	awful.keyboard.append_client_keybindings({
		...
		awful.key({ mod, shift, ctrl }, "i", function(c)
