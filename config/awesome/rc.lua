...
local config_awesome = config_home .. 'awesome/'
local themes = config_awesome .. 'themes/'
local assets = themes .. 'assets/'
...
globalkeys = gears.table.join(
	...
	awful.key({ super, }, "Return",
		function() awful.spawn(M.vars.terminal) end,
	...
	-- Menubar
	awful.key({ super }, "p",
		function() menubar.show() end, { description = "show the menubar", group = "launcher"}
	)
)
