...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#DC322F'
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND='#93A1A1'
  ...
  function my_git_formatter() {
    ...
    local       meta='%7F' # white foreground %7F
    local      clean='%0F' # black foreground %0F
    local   modified='%0F' # black foreground %0F
    local  untracked='%0F' # black foreground %0F
    local conflicted='%1F' # red foreground %1F
