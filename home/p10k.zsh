...
() {
	...
	# Use the same color as POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND.
	# Connect left prompt lines with these symbols.
	typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{#03cedf}╭─%f'
	typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{#03cedf}├─%f'
	typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{#03cedf}╰─%f'

	# Connect right prompt lines with these symbols.
	typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%F{#03cedf}─╮%f'
	typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%F{#03cedf}─┤%f'
	typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%F{#03cedf}─╯%f'

	# Filler between left and right prompt on the first prompt line. You can 
	# set it to ' ', '·' or '─'. The last two make it easier to see the 
	# alignment between left and right prompt and to separate prompt from 
	# command output. Set POWERLEVEL9K_PROMPT_ADD_NEWLINE=false
	# for more compact prompt if using this option.
	typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR='─'
	typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_BACKGROUND=
	typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_GAP_BACKGROUND=
	if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
		typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND='#03cedf'
	...
	typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#65fe56'
	typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#dcdf48'
	typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#839496'
	typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#ff5664'
	typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND='#4476df'
	...
	function my_git_formatter() {
		...
		if [[ -n $VCS_STATUS_TAGv&& -z $VCS_STATUS_LOCAL_BRANCH ]]; then
	...
	typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#110101'
	typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#c3c0c1'
	...
	# Custom icon.
	typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_VISUAL_IDENTIFIER_EXPANSION='󰦖 '
	# Custom prefix.
	...
	typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#073642'
	typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND='#93A1A1'

	# Context format when running with privileges: user@hostname.
	typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{#CB4B16} '  #'%n@%m'
